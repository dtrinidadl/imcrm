...
<div class="row">
    <div class="col-md-12">
        <input type="button" class="btn btn-success btn-wd" onclick="fntShowModalPerfil('0');" value="Crear Nuevo Perfil">
        <input type="button" class="btn btn-success btn-wd" onclick="fntShowModalAccesos('0');" value="Crear Nuevo Acceso">
    </div>
</div>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        ...
                        <tbody>
                            <?php while ($data = $lista_perfiles->fetch_object()): ?>
                                ...
                                <tr>
                                    <td>
                                        <span class="badge badge-success h5" onclick="fntShowModalPerfil('<?= $data->id_perfil; ?>');" style="cursor: pointer"><?= $data->id_perfil; ?></span>
                                    </td>
                                    <td><?= $data->nombre; ?></td>
                                    <td><?= utils::getEstadoAIById($data->estado); ?></td>
                                    <td>
                                            <button class="btn btn-success" onclick="fntShowModalAccesosPerfil('<?= $data->id_perfil ?>');">Ver Accesos</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
...
<div class="modal fade" id="infoComercios" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <button class="btn btn-warning btn-link" onclick="buscarEmpresa();">Buscar</button>
                        </div>
                    </div>
                </div>
