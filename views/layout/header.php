...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url ?>assets/css/custom-style.css" media="screen" />

</head>

<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="success" data-background-color="black" style="background: green;">