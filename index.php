                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
                            <form class="form" method="POST" action="<?= base_url ?>usuario/validate">
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="card-body ">
                                        <p class="card-description text-center">Ingrese la información solicitada</p>
                                    ...
                                    <div class="card-footer justify-content-center">
                                        <?php if (isset($_SESSION['error-login']) && $_SESSION['error-login'] == "error"): ?>
                                            <div><span style="color: red;">Usuario o Contraseña Invalidos!</span></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="card-footer justify-content-center">
